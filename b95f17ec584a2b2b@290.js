...
function _menuLocalidade(TL,municipios,Event){return(
function menuLocalidade(config) {
  let coresDisponiveis = [...config.cores];
  let selecionados = new Map();
  let placeholder = config["placeholder"] || TL("Adicione um local");
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("menuLocalidade")).define("menuLocalidade", ["TL","municipios","Event"], _menuLocalidade);
