...
import define2 from "./95a6dd468792e4c1@172.js";
...
function _mapaMunicipio(TL,xAxisSelect,yAxisSelect,colorSelect,escalaCores,makeTooltipFunc,d3tip,alteraMenuLocalidade,$0,panel,mapConfig,indicadoresPorCodigo,posicaoPorCodigo,bubbleMap,posicoesMunicipios,invalidation,$1,d3)
{
  TL; // Reactive dependency
...
FileAttachment("translations@5.tsv").tsv()
)}

function _TL(URLSearchParams,setTLConfig,tradDb,$0,TLoriginal,$1,$2,$3)
{
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["translations@5.tsv", {url: new URL("./files/5c267d4f3cfee2a77141d6e2619bd5f20345f2f491a9654fa50ffee212eacce6aa3e501f7ff90ee385cd7a55e25e720b520b74eddf73528de113d12f56cbd3b2.tsv", import.meta.url), mimeType: "text/tab-separated-values", toString}]
  ]);
  ...
  main.variable(observer("mapaMunicipio")).define("mapaMunicipio", ["TL","xAxisSelect","yAxisSelect","colorSelect","escalaCores","makeTooltipFunc","d3tip","alteraMenuLocalidade","viewof munSelecionados","panel","mapConfig","indicadoresPorCodigo","posicaoPorCodigo","bubbleMap","posicoesMunicipios","invalidation","mutable mapConfig","d3"], _mapaMunicipio);
  ...
  main.define("initial TL", ["URLSearchParams","setTLConfig","tradDb","mutable TLscatter","TLoriginal","mutable TLfilter","mutable TLranking","mutable TLmap"], _TL);
