...
import define4 from "./13f8329f2c6d6972@67.js";
...
function _bubbleMap($0,$1,d3,html,flagPath){return(
function (data, options = {}) {
  ...
  svg
    ...
    .on("wheel", function (e) {
      e.preventDefault();
      e.stopPropagation();
      const scaleFactor = e.deltaY < 0 ? 101 / 100 : 100 / 101;
...
export default function define(runtime, observer) {
  ...
  main.import("mutable TL", "mutable TLToolTip", child4);
  main.import("TL", "TLToolTip", child4);
  ...
  main.variable(observer("bubbleMap")).define("bubbleMap", ["mutable TL","mutable TLToolTip","d3","html","flagPath"], _bubbleMap);
