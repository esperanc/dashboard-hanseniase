...
function _mainWindow(toolTipStyles,stylesFilter,stylesRanking,stylesMenuLoc,htl){return(
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("mainWindow")).define("mainWindow", ["toolTipStyles","stylesFilter","stylesRanking","stylesMenuLoc","htl"], _mainWindow);
