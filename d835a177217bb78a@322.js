...
function _scatter(dblClickInteraction,applyDotAnimation,rectSelect,scatterPlot,scatterData,flagsData,scatterConfig,TL,variaveis,colorScale,getNomeMunicipio,$0,data,alteraMenuLocalidade,htl,dataRange,makeIcon,noRange)
{
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("scatter")).define("scatter", ["dblClickInteraction","applyDotAnimation","rectSelect","scatterPlot","scatterData","flagsData","scatterConfig","TL","variaveis","colorScale","getNomeMunicipio","mutable dataRange","data","alteraMenuLocalidade","htl","dataRange","makeIcon","noRange"], _scatter);
