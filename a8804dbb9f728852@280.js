...
FileAttachment("translations@2.tsv").tsv()
)}

function _TL(URLSearchParams,setTLConfig,tradDb,$0,TLoriginal,$1,$2)
{
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["translations@2.tsv", {url: new URL("./files/597c66450499882f8ce7c416ec958e44bbaa88ca0de50b3243ae25f6a8d3ee0078c846227b35230659a9beb69d86044a408cf2a89d1a017bad52a9a02e67ce5c.tsv", import.meta.url), mimeType: "text/tab-separated-values", toString}]
  ]);
  ...
  main.define("initial TL", ["URLSearchParams","setTLConfig","tradDb","mutable TLscatter","TLoriginal","mutable TLfilter","mutable TLranking"], _TL);
