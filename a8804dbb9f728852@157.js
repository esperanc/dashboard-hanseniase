...
function _30(stylesMenuLoc){return(
stylesMenuLoc
)}

function _32(stylesFilter){return(
stylesFilter
)}

function _35(stylesRanking){return(
stylesRanking
)}

function _41(toolTipStyles){return(
toolTipStyles
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["stylesMenuLoc"], _30);
  ...
  main.variable(observer()).define(["stylesFilter"], _32);
  ...
  main.variable(observer()).define(["stylesRanking"], _35);
  ...
  main.variable(observer()).define(["toolTipStyles"], _41);
  return main;
}
