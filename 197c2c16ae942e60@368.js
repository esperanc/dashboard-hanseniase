...
function _14(Inputs,tab_pop){return(
...
function _getIndicadores(hansIndexAno,tab_hans,indexPop,getPop,resumoAno)
{
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["Inputs","tab_pop"], _14);
  ...
  main.variable(observer("getIndicadores")).define("getIndicadores", ["hansIndexAno","tab_hans","indexPop","getPop","resumoAno"], _getIndicadores);
