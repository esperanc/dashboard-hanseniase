...
import define3 from "./d835a177217bb78a@322.js";
import define4 from "./13f8329f2c6d6972@65.js";
...
function _mapaMunicipio(variables,makeColorScale,variaveis,makeTooltipFunc,d3tip,alteraMenuLocalidade,$0,indicadoresPorCodigo,posicaoPorCodigo,bubbleMap,posicoesMunicipios,d3)
{
...
function _12(toolTipStyles){return(
toolTipStyles
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("mapaMunicipio")).define("mapaMunicipio", ["variables","makeColorScale","variaveis","makeTooltipFunc","d3tip","alteraMenuLocalidade","viewof munSelecionados","indicadoresPorCodigo","posicaoPorCodigo","bubbleMap","posicoesMunicipios","d3"], _mapaMunicipio);
  ...
  main.variable(observer()).define(["toolTipStyles"], _12);
  main.variable(observer("d3tip")).define("d3tip", ["require"], _d3tip);
  main.variable(observer()).define(["md"], _14);
  main.variable(observer("TL")).define("TL", _TL);
