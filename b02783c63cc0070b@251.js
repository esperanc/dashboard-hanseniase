...
function _sels(menuLocalidade){return(
menuLocalidade({ value:["RIO DE JANEIRO", "SÃO PAULO"], cores: ["#2F87F5", "#D8C56C", "#DC5988", "#6CC28D"]})
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("viewof sels")).define("viewof sels", ["menuLocalidade"], _sels);
  main.variable(observer("sels")).define("sels", ["Generators", "viewof sels"], (G, _) => G.input(_));
  main.variable(observer()).define(["viewof sels"], _3);
  main.variable(observer()).define(["sels"], _4);
