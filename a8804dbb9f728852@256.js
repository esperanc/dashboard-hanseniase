...
function _tradDb(){return(
[]
)}

function _TL(setTLConfig,tradDb,$0,TLoriginal,$1)
{
  setTLConfig("orig", "pt", tradDb);
  $0.value = TLoriginal;
  $1.value = TLoriginal;
  // mutable TLmap = TLoriginal;
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("tradDb")).define("tradDb", _tradDb);
  main.define("initial TL", ["setTLConfig","tradDb","mutable TLscatter","TLoriginal","mutable TLfilter"], _TL);
